              ...
              {calendarCells.map((cell, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative flex flex-col min-h-[70px] sm:min-h-[100px] p-1.5 sm:p-2.5 rounded-2xl border transition-all duration-200 text-left ${
                      isCurrent
                        ? isSelected
                        ...
                        <>
                          ...
                          <div className="hidden sm:flex flex-col gap-1 w-full mt-1">
                            {cellEvents.map((ev) => (
                              <span
                                key={ev.id}
                                className={`px-1.5 py-0.5 rounded text-[10px] font-bold truncate block border ${
                                  ev.server === 'Dev' ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-600 dark:text-emerald-400' :
                        ...
                        <div className="min-w-0 flex-1 pr-2">
                          ...
                          <div className="text-xs text-muted-foreground mt-1 flex items-center gap-2 flex-wrap">
                            <span className={`px-1.5 py-0.5 rounded text-[9px] font-semibold ${
                              event.server === 'Dev' ? 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400' :
